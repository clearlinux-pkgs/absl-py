...
%prep
%setup -q -n absl-py-0.10.0
cd %{_builddir}/absl-py-0.10.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1597936008
...
cp %{_builddir}/absl-py-0.10.0/LICENSE %{buildroot}/usr/share/package-licenses/absl-py/2b8b815229aa8a61e483fb4ba0588b8b6c491890
