...
%prep
%setup -q -n absl-py-0.15.0
cd %{_builddir}/absl-py-0.15.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1634747338
...
cp %{_builddir}/absl-py-0.15.0/LICENSE %{buildroot}/usr/share/package-licenses/absl-py/2b8b815229aa8a61e483fb4ba0588b8b6c491890
